...
# Loop has a fork for 
  # 1) species which occur at just a single site, and 
  # 2) species that occur at multiple sites. 
...
dim(dat)  # 56347 observations, 12 variables
...
# SET UP DATA FRAMES FOR RESULTS COLLECTION
...
# --- (ELSE) LOOP FOR SPECIES WITH MORE THAN 1 SITE ---
...
# SPECIES LEVEL: PARAMETER ESTIMATES --
