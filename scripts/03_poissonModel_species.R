# Poisson model for abundance data - Fourth of July. Species-level parameters are estimated in hierarchical 
# models for each spp.. Code is very wet for clarity.
library(rjags)
library(coda)
library(HDInterval)
