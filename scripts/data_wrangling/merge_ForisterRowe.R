...
# Creating a duplicate az_naba_all which will be used to remove the unidentified species in the richness counts 
...
# BUTTERFLY RICHNESS AND COUNT DATA ---
...
Butterfly_summary <- left_join(Total_butterfly, Total_butterfly2, 
...
# Deleting the unneeded portal site
daily_weather <- daily_weather %>% 
  filter(Latitude != 33.8500)
